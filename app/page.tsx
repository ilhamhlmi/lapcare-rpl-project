...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section id="hero" className="min-h-screen w-full flex items-center pt-16">
        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-center items-center gap-3 mb-5">
            <button className="border px-10 py-2 rounded-full text-darkb bg-white border-white cursor-pointer hover:text-white font-poppins hover:bg-transparent transition duration-300">
              Cari Panduan
            </button>
            <button className="border px-8 py-2 rounded-full text-white bg-primary border-primary cursor-pointer hover:text-white font-poppins hover:bg-transparent hover:border-white transition duration-300">
              Mulai Konsultasi
            </button>
          </div>
      ...
      <section id="faq" className="w-full flex items-center bg-slate-200 pt-16 pb-16 px-4 lg:px-6">
        <div className="container mx-auto bg-gradient-to-tl from-[#1d293d] via-[#23385e] to-[#3b82f6] border-transparent rounded-2xl pt-12 pb-12"  data-aos="fade-up">
          ...
          <div className="bg-white/5 backdrop-blur-md w-[350px] lg:w-3xl 2xl:w-4xl flex-col justify-items-center mx-auto rounded-lg border border-secondary text-center divide-y divide-white mb-8" data-aos="fade-up">
            <details className="py-4 px-4 w-full border-secondary">
