        ...
        <div className="container mx-auto flex items-center justify-center px-4 xl:px-0">
          <div className="w-full xl:w-2/3 bg-white backdrop-blur-2xl border border-darkb shadow-2xl rounded-2xl flex flex-col items-center justify-center px-7 xl:px-10 py-10">
            ...
            <div className="flex flex-col items-center justify-center space-y-2 w-full xl:w-2/3 text-center">
              <Link href="/userProfile/editProfile" className="border rounded-full px-6 py-1 font-poppins border-primary bg-primary hover:bg-sky-700 hover:border-sky-700 shadow-md hover:shadow-2xl duration-300 text-white cursor-pointer w-full">Edit Profile</Link>
              <Link href="/userProfile/riwayatLayanan" className="border rounded-full px-6 py-1 font-poppins border-primary bg-primary hover:bg-sky-700 hover:border-sky-700 shadow-md hover:shadow-2xl duration-300 text-white cursor-pointer w-full">Lihat Riwayat Layanan</Link>
