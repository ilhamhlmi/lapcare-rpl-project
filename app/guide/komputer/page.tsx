...
export default function computerGuide() {
    return (
        <div>
            <NavbarClient />
            ...
            <section className="bg-slate-200 pt-32 pb-16">
                <div className="container mx-auto">
                    <div className="flex justify-center items-center mb-5">
                        <h1 className="text-darkb font-poppins text-2xl 2xl:text-3xl font-semibold border-b pb-5 border-secondary">Panduan Komputer</h1>
                    </div>
