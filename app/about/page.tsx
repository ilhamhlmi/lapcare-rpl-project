        ...
        <div>
            ...
            <section className="pt-32 pb-16 bg-slate-200">
                <div className="container mx-auto">
                    ...
                    <div className="flex justify-center items-center text-center px-4 mb-5">
            ...
            <section className="pb-16 bg-slate-200">
                <div className="w-full bg-gradient-to-tl from-[#1d293d] via-[#23385e] to-[#3b82f6] pt-12 pb-12">
                    ...
                    <div className="flex justify-center items-center mt-8 px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-5 lg:7 2xl:10">
                            <div className="flex border px-8 py-5 border-secondary rounded-2xl bg-white/5 backdrop-blur-md">
