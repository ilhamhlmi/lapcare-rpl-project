                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 gap-5 lg:7 2xl:10">
                            <div className="flex border px-8 py-5 border-secondary rounded-2xl bg-white/5 backdrop-blur-md shadow-lg" data-aos="fade-up">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h1 className="font-poppins font-semibold">Integritas & Transparansi</h1>
                            ...
                            <div className="flex border px-8 py-5 border-secondary rounded-2xl bg-white/5 backdrop-blur-md shadow-lg" data-aos="fade-up">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h1 className="font-poppins font-semibold">Kecepatan & Efisiensi</h1>
                            ...
                            <div className="flex border px-8 py-5 border-secondary rounded-2xl bg-white/5 backdrop-blur-md shadow-lg" data-aos="fade-up">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h1 className="font-poppins font-semibold">Kepedulian & Empati</h1>
                            ...
                            <div className="flex border px-8 py-5 border-secondary rounded-2xl bg-white/5 backdrop-blur-md shadow-lg" data-aos="fade-up">
                                ...
                                <div className="flex flex-col justify-center">
                                    <h1 className="font-poppins font-semibold">Kepuasan Pengguna</h1>
                    ...
                    <div className="flex items-center justify-center px-4">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                            <div className="flex flex-col items-center justify-center text-center">
                                <h1 className="text-darkb font-poppins font-semibold border-b-2 pb-1 px-3 border-darkb mb-3 text-2xl lg:text-3xl" data-aos="fade-up">Visi</h1>
                                <p className="text-black max-w-sm lg:max-w-md font-poppins text-md lg:text-lg" data-aos="fade-up">Menjadi mitra terpercaya dalam konsultasi dan layanan perbaikan perangkat digital yang cepat, efisien, dan berkualitas tinggi, dengan mengutamakan kepuasan pengguna serta nilai kolaborasi dalam setiap proses pelayanan, kami akan melayani dengan sepenuh hati.</p>
                            </div>
                            <div className="flex flex-col items-center justify-center text-center">
                                <h1 className="text-darkb font-poppins font-semibold border-b-2 pb-1 px-3 border-darkb mb-3 text-2xl lg:text-3xl" data-aos="fade-up">Misi</h1>
                                <p className="text-black max-w-sm lg:max-w-md font-poppins text-md lg:text-lg" data-aos="fade-up">Memberikan solusi terbaik melalui layanan konsultasi dan perbaikan yang responsif, transparan, dan penuh kepedulian, serta berkomitmen menjaga kepercayaan pengguna melalui inovasi berkelanjutan dan kerja sama tim yang profesional.</p>
                            </div>
                        </div>
                    </div>
                </div>
